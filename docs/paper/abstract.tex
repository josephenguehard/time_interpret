...
any Pytorch model.
\texttt{\detokenize{time_interpret}} also provides several synthetic and real world time series datasets, various PyTorch
...
\texttt{\detokenize{time_interpret}}\footnote{
